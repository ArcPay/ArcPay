...
- Run `node mint.js` in [`circuits/scripts`](./circuits/scripts/) which prints the data for 2 iterations.
- Stringify any remaining numbers and copy it to [`mint.json`](./circuits/inputs/mint.json`).
